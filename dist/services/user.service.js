...
const UserService = {
    findOneByEmail: (email) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            return yield data_source_1.KevDB.getRepository(user_entity_1.User)
    ...
    register: (_a) => __awaiter(void 0, [_a], void 0, function* ({ email, password, name, file }) {
        let avatar = "";
        try {
            ...
            yield data_source_1.KevDB.createQueryBuilder()
                .insert()
